    ...
    <div class="fluid container mx-auto sm:px-4">
        ...
        <div class="flex flex-wrap">
            ...
            <div v-if="selectedElementLevel1" class="md:w-1/4 pr-4 pl-4">
                ...
                >
                    <li
                        v-for="(element, index) in selectedElementLevel1.items"
                        :key="element.order"
            ...
            <div v-if="selectedElementLevel1 && selectedElementLevel2" class="md:w-1/4 pr-4 pl-4">
                <draggable
                ...
                >
                    <li
                        v-for="(element, index) in selectedElementLevel2.items"
                        :key="element.order"
                        class="relative block py-3 px-6 -mb-px border border-r-0 border-l-0 border-gray-300 no-underline"
                    >
                        <span>
