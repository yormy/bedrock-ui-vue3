<template>
    <div>
        <y-modal-info :id="'modal-above-' + checkboxId" :size="aboveModalSizing" :title="aboveModalTitle" styling="is-info">
            {{ aboveModalDescription }}
        </y-modal-info>

        <y-modal-info :id="'modal-below-' + checkboxId" :size="belowModalSizing" :title="belowModalTitle" styling="is-info">
        ...
        <div class="y-checkable">
            <div class="flex flex-col">
                ...
                <input :id="checkboxId" v-model="prop.value" class="checkbox-input" type="checkbox" @change="onChange($event)" />
